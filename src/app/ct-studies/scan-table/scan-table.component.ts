...
export class ScanTableComponent implements AfterViewInit, AfterViewChecked {
  ...
  displayedColumns: string[] = ['description', 'modality', 'scanDate', 'bodyPart', 'patient', 'delete'];
  dataSource = new MatTableDataSource<Scan>(this.filteredScans);
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  constructor(private scanService: ScanService, private toastr: ToastrService, private changeDetectorRef: ChangeDetectorRef) {
  }
